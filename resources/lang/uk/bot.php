...
//                "та вказавши населений пункт. \n" .
            ...
            "ask_for_the_address_correction" => "Вибач за незручності, я обов'язково виправлю це! \n" .
                "До речі ти можеш допомогти мені надіславши вірну адресу: \n" .
                "(поточна адреса: _:current_address_)",

            "confirm_address_request" => "Отже це актуальна адреса церкви *:church*? \n" .
                "_:address_",
            ...
            'pastors_help' => 'Ось список пасторів, які відповідають за розселення та надання допомоги',
        ],
    ],
];
