 ...
 * @since  08.09.2019
 */
class CannotProvideRightAddressActions extends AbstractUpdateHandler implements CallbackQueryHandlerInterface
{
    public const CALLBACK_DATA = "cannot_provide_right_address";
